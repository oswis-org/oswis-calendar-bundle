...
class ParticipantPaymentsImportService
{
    ...
    public function processImport(ParticipantPaymentsImport $paymentsImport, CsvPaymentImportSettings $importSettings): void
    {
    ...
    public function getParticipantByPayment(ParticipantPayment $payment, bool $isSecondTry = false): ?Participant
    {
        ...
        usort($participantsArray, fn(Participant $p1, Participant $p2) => self::cmpParticipantsByPayment($value, $p1, $p2));
