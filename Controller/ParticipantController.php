...
{
    public ContactDetailTypeRepository $contactDetailTypeRepository;

    public LoggerInterface $logger;

    public RegRangeService $registrationsRangeService;
    ...
    public function __construct(
        ...
        RegRangeService $registrationService,
    ...
    public function getEmptyParticipant(RegRange $regRange, ?AbstractContact $contact = null): Participant
    {
        ...
        return new Participant($regRange, $this->getContact($regRange->getEvent(), $contact), new ArrayCollection([new ParticipantNote()]), null);
    }
    ...
    public function getContact(Event $event, ?AbstractContact $contact = null): AbstractContact
    {
        ...
        return $contact ?? new Person(
                ...
                null,
                new ArrayCollection([new Position(null, null, null, Position::TYPE_STUDENT)]),
    ...
    public function processToken(?string $token = null, ?int $participantId = null): Response
    {
        ...
        if (ParticipantToken::TYPE_ACTIVATION === $type) {
            return $this->processTokenActivation($participantToken);
        }
        throw new TokenInvalidException('nebyla vykonána žádná akce');
    }

    public function processTokenActivation(ParticipantToken $participantToken): Response
    {
        $this->participantService->activate($participantToken->getAppUser(), true);
